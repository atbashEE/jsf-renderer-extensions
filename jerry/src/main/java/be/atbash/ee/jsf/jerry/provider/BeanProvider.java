 ...
 */
package be.atbash.ee.jsf.jerry.provider;
...
public final class BeanProvider {
     ...
     * @see #getContextualReference(Class, boolean, java.lang.annotation.Annotation...)
     */
    ...
    /**
     * {@link #getContextualReference(Class, java.lang.annotation.Annotation...)} which returns <code>null</code> if the 'optional' parameter
     ...
     * @param <T>        target type
     * @return the resolved Contextual Reference
     * @see #getContextualReference(Class, java.lang.annotation.Annotation...)
     */
