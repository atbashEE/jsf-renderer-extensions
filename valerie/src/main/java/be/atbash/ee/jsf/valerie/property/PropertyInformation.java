 ...
 * (e.g. {@link be.atbash.ee.jsf.valerie.property.PropertyDetails})
...
public interface PropertyInformation extends MetaDataHolder {
     ...
     * Some predefined keys are defined in {@link be.atbash.ee.jsf.jerry.metadata.PropertyInformationKeys}.
     *
    ...
    /**
     * Adds the given {@link be.atbash.ee.jsf.jerry.metadata.MetaDataEntry}
     *
     * @param metaDataEntry {@link be.atbash.ee.jsf.jerry.metadata.MetaDataEntry} to store.
     */
