...
public final class MavenDependencyUtil {
    ...
    private static final String JERRY_CANONICAL_FORM = "be.atbash.ee.jsf:jerry";
    private static final String VALERIE_CANONICAL_FORM = "be.atbash.ee.jsf:valerie";
    private static final String VALERIE_PRIMEFACES_CANONICAL_FORM = "be.atbash.ee.jsf.valerie:primefaces";
